<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800 custom-header">
  <div class="container flex items-center justify-end h-full px-6 mx-auto text-green-600 dark:text-green-300">
    ...
    <div class="flex justify-center flex-1">
      <a class="inline-flex items-center text-sm mr-5 font-semibold transition-colors duration-150 text-green-600 hover:text-green-800"
        href="{{ url('user') }}">
