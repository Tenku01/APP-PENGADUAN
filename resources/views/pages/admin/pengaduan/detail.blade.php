  ...
  <div class="container grid px-6 mx-auto">
    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
      <div class="w-full overflow-x-auto">
        ...
        <div
          class="text-gray-800 text-sm font-semibold px-4 py-4 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:text-gray-400" style="background-color:#FBFADA !important;">
        ...
        <div class="px-4 py-3 mb-8 flex text-gray-800 bg-white rounded-lg shadow-md dark:bg-gray-800" style="background-color:#FBFADA !important;">
        ...
        <div class="px-4 py-3 mb-8 flex bg-white rounded-lg shadow-md dark:text-gray-400   dark:bg-gray-800">
          ...
          <div class="text-center flex-1">
            ...
            <p class="text-gray-800 dark:text-gray-400">
              ...
              Belum ada tanggapan
              @else
              {{ $tangap->tanggapan }}  <!-- Tampilkan tanggapan terbaru -->
              @endif
            </p>
          </div>
        </div>
